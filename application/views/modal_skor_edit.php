		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title">
            		...
            		Edit Skor <?php echo $row->id; ?>
            	</div>
            </div>
			<div class="panel-body">
				
                <?php echo form_open(base_url() . 'skor/go/edit/'. $row->id , array('class' => 'form-horizontal form-groups-bordered validate'));?>

					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">Skor Kuesioner</label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="skor" value="<?php echo $row->nilai; ?>" >
						</div>
					</div>
