                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Komik
                        <div class="pull-right">
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_komik_add/');" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> tambah</a> 
                        </div>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<?php
											...
											$no=1;
											foreach($data_komik->result() as $row){
										?>
	                                        <tr class="">
	                                            <td><?php echo $no++;?></td>
	                                            <td><a href="<?php echo base_url();?>comic/getComic/<?php echo $row->id;?>"><?php echo $row->nama_komik;?></a></td>
	                                            <td><?php echo word_limiter($row->keterangan,7);?></td>
	                                            ...
	                                            <td>
                                                    ...
                                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>comic/go/delete/<?php echo $row->id;?>');" class="icon huge" data-toggle="modal" title="remove"><i class="fa fa-trash-o"></i></a>&nbsp;
                                                </td>
	                                        </tr>
	                                        <?php } ?>
                                    </tbody>
