                            ...
                            ?>>
                                ...
                                <td class="align-center">
                                    ...
                                    <?php if ($cat['dv_state'] == 0): ?>
                                        <a href="<?= base_url() ?>admin_voting/activate_vote/<?= $cat['dv_id']; ?>"><img src="<?= base_url() ?>global/admin/images/tick-circle.gif" width="16" height="16"  title="act" alt="خيارات النشر" /></a>
                                    <?php else : ?>
                                        <a href="<?= base_url() ?>admin_voting/deactivate_vote/<?= $cat['dv_id']; ?>"><img src="<?= base_url() ?>global/admin/images/minus-circle.gif" width="16" height="16" title="inact" alt="خيارات النشر النشر" /></a>
                                    <?php endif; ?>
                                </td>
