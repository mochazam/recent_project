                                    ...
                                    <tbody>
										...
										?>
	                                        <tr class="">
	                                            ...
	                                            <td class="center"><?php echo $row->NIDN;?></td>
                                                <td>
                                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_dosen_edit/<?php echo $row->kode_dosen;?>');" class="icon huge" title="edit"><i class="fa fa-pencil"></i></a>&nbsp;
                                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>dosen/go/delete/<?php echo $row->kode_dosen;?>');" class="icon huge" data-toggle="modal" title="remove"><i class="fa fa-trash-o"></i></a>&nbsp;
                                                </td>
	                                        </tr>
	                                        <?php } ?>
                                    </tbody>
