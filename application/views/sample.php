	...
	<tr>
		...
		<!--CONTENT STARTS HERE-->
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td width="15"><div style="line-height: 0px; font-size: 1px; position: absolute;">&nbsp;</div></td>
					<td width="325" style="padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;" valign="top">
						<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">Dear Adim,</span>
						<br />
		...
		<div style="padding-left:20px; padding-bottom:10px;"><img src="images/spade.gif" alt=""/>&nbsp;&nbsp;&nbsp;Benefit of receiving email (#3)</div>-->
						...
						<p>In the meantime, you can <a href="http://eknowledgetree.com/">return to my website</a> to continue browsing.</p>
						...
						This welcome email was sent to you because you recently signed up for
						<a href="http://eknowledgetree.com/">eknowledgetree.com</a>.
					...
					<td style="border-left:1px solid #e4e4e4; padding-left:15px;" valign="top">
						...
						<table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #e4e4e4; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;">
							<tr>
								<td>
									...
									<img src="<?php echo base_url();?>images/addressbook.gif" align="right" style="padding-left:10px; padding-top:10px; padding-bottom:10px;" alt=""/>
									<p>To help ensure that you receive all email messages consistently in your inbox with images displayed, please add this address to your address book or supports list: <strong><a href="mailto:support@eknowledgetree.com">support@eknowledgetree.com</a></strong>.</p>
						...
						<div style="clear:both; margin-top:0em; margin-bottom:1em;">
							<a href="http://www.eknowledgetree.com/codeigniter/google-maps-integration-codeigniter/" target="_blank" rel="nofollow" class="u2deab675846039a0356701285dac5f2a">%MINIFYHTMLe804212f2f88e56816eae5b3241c140e39%
								<div style="padding-left:1em; padding-right:1em;">
									<span class="ctaText">READ</span>  
									<span class="postTitle">Google maps integration with codeigniter</span>
								</div>
							</a>
						</div>	
...
<table cellpadding="0" style="border-top:1px solid #e4e4e4; text-align:center; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;" cellspacing="0" width="600">
	...
	<tr>
		<td style="font-family:Trebuchet MS, Verdana, Arial; font-size:12px;">
			<br />
		 	<strong><a href="mailto:support@eknowledgetree.com">support@eknowledgetree.com</a></strong><br />
		</td>
	</tr>
</table>
</center>
