                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Question
                        <div class="pull-right">
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_question_add/');" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> tambah</a> 
                        </div>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<?php
											...
											$no=1;
											foreach($data_question->result() as $row){
										?>
	                                        <tr class="">
	                                            <td><?php echo $no++;?></td>
                                                <td><?php echo $row->test_name;?></td>
	                                            <td class="center"><?php echo word_limiter($row->question,7);?></td>
	                                            ...
	                                            <td>
                                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_question_edit/<?php echo $row->id_question;?>');" class="icon huge" title="edit"><i class="fa fa-pencil"></i></a>&nbsp;
                                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>exam/manage_question/delete/<?php echo $row->id_question;?>');" class="icon huge" data-toggle="modal" title="remove"><i class="fa fa-trash-o"></i></a>&nbsp;
                                                </td>
	                                        </tr>
	                                        <?php } ?>
                                    </tbody>
