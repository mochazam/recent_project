...
<!-- Form Start -->
<div class="block">
    <div class="title lightTextShadow"><?php echo $this->lang->line('category_edit')? $this->lang->line('category_edit') : 'Edit'; ?></div>
    <br/>

    <div class="content">
        <?php echo form_open_multipart('admin_country/edit/' . $category->country_id) ?>
