...
<div class="container">
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Matakuliah
                        <div class="pull-right">
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_matakuliah_add/');" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> tambah</a> 
                        </div>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
                                    ...
                                    <tbody>
										...
										?>
	                                        <tr class="">
	                                            ...
	                                            <td class="center"><?php echo $row->jum_sks;?></td>
	                                            <td class="center"><?php echo $row->semester;?></td>
                                                <td>
                                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_matakuliah_edit/<?php echo $row->kode_mk;?>');" class="icon huge" title="edit"><i class="fa fa-pencil"></i></a>&nbsp;
                                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>matakuliah/go/delete/<?php echo $row->kode_mk;?>');" class="icon huge" data-toggle="modal" title="remove"><i class="fa fa-trash-o"></i></a>&nbsp;
                                                </td>
	                                        </tr>
	                                        <?php } ?>
                                    </tbody>
