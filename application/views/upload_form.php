...
<body>
  ...
  <?php echo form_open_multipart('multiple') ?>
    ...
    <div class="form-group col-lg-12">
        <div class="form-group col-lg-6">
            <input class="form-control" type="file" name="uploadedimages[]" required > 
        </div>
        <div class="paste" ></div>              
    </div> 
...
$(document).ready(function(){
    ...
    $('.count').attr('id',count)
            var html   =  ' <div class="form-group col-lg-6">';
                html  +=   '<input class="form-control" type="file" name="uploadedimages[]" >';
                html  += '</div>';
            $('.paste').append(html);
        });
