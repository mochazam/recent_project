...
<div class="container">
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Artikel
                        <div class="pull-right">
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_artikel_add/');" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> tambah</a> 
                        </div>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
                                    ...
                                    <tbody>
										...
										?>
	                                        <tr class="">
	                                            ...
	                                            <td class="center"><?php echo word_limiter($row->body,7);?></td>
                                                <td><?php echo $row->nama_kategori; ?></td>
                            					<td><?php echo $row->date; ?></td>
	                                            <td>
                                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_artikel_edit/<?php echo $row->id_artikel;?>');" class="icon huge" title="edit"><i class="fa fa-pencil"></i></a>&nbsp;
                                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>artikel/go/delete/<?php echo $row->id_artikel;?>');" class="icon huge" data-toggle="modal" title="remove"><i class="fa fa-trash-o"></i></a>&nbsp;
                                                </td>
	                                        </tr>
	                                        <?php } ?>
                                    </tbody>
